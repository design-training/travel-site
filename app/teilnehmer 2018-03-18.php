...
<head>
  ...
  <title>design &#9670; training &#9670; Teilnehmer</title>
...
<body id="teilnehmer">
  ...
  <div class="wrapper">
    ...
    <h3 class="headline">Alle Menschen sind gleich. Sie unterscheiden sich durch ihre Gewohnheiten. Trainings für:</h3>

    <div class="card-container">
      <div class="card">
        <div class="card card__num1">
          <!-- <h6>Karte 1</h6> -->
        </div>
        <div class="card card__num2">
          <!-- <h6>Karte 2</h6> -->
        </div>
        <div class="card card__num3">
          <!-- <h6>Karte 3</h6> -->
        </div>
        <div class="card card__num4">
          <!-- <h6>Karte 4</h6> -->
        </div>
        <div class="card card__num5">
          <!-- <h6>Karte 5</h6> -->
        </div>
        <div class="card card__num6">
          <!-- <h6>Karte 6</h6> -->
        </div>
      </div>
    </div>

    <h3 class="headline-2">Viele Inhalte sind ähnlich. Sie unterscheiden sich in der Art der Vermittlung.</h3>
